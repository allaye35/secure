...
$jsonContent = Get-Content -Path "nouveau-contrat.json" -Raw
...
$jsonContent
--$boundary
Content-Disposition: form-data; name="file"; filename="nouveau-contrat.pdf"
Content-Type: application/pdf

$(Get-Content -Path "nouveau-contrat.txt" -Raw)
--$boundary--
"@
